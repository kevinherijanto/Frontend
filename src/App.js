                  ...
                  <div className="mt-8">
                    ...
                    <div className="space-y-2 mb-4">
                      {chatMessages.map((msg, idx) => (
                        <div key={idx} className="p-2 bg-gray-100 rounded-md shadow-sm">
                          <strong className="block">{msg.username}</strong>
                          <p>{msg.message}</p>
                        </div>
                      ))}
                    </div>
                    ...
                    <button
                      onClick={sendMessage}
                      className="w-full mt-2 py-2 px-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700"
                    >
                      Send Message
                    </button>
                    <button
